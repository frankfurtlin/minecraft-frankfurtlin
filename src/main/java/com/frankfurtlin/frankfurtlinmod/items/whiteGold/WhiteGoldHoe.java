 ...
 * 一键捡掉落物
 */
public class WhiteGoldHoe extends HoeItem {
     ...
     * @param settings     设置
     */
    public WhiteGoldHoe(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
    ...
    private void applyBreakCrops(World world, PlayerEntity user, BlockPos pos) {
        BlockPos.iterateOutwards(pos, WhiteGoldHoe.rangeRadius, WhiteGoldHoe.rangeHeight, WhiteGoldHoe.rangeRadius).forEach(blockPos -> {
