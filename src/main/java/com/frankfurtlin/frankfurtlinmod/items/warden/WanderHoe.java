 ...
 * 一键捡掉落物
 */
public class WanderHoe extends HoeItem {
     ...
     * @param settings     设置
     */
    public WanderHoe(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
    ...
    private void applyBreakCrops(World world, PlayerEntity user, BlockPos pos) {
        BlockPos.iterateOutwards(pos, WanderHoe.rangeRadius, WanderHoe.rangeHeight, WanderHoe.rangeRadius).forEach(blockPos -> {
